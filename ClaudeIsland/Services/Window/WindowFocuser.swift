...
actor WindowFocuser {
    ...
    func focusTerminalApplication(
        ...
        await selectMatchingTerminalTabIfNeeded(
            pid: pid,
    ...
    private func selectMatchingTerminalTabIfNeeded(
        pid: Int,
        ...
        let scriptLines = [
            ...
            "set matchedTerminal to currentTerminal",
            "end if",
            "end repeat",
            "end repeat",
            "end repeat",
            "activate",
            "if matchedTerminal is not missing value then",
